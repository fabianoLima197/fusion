    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificados', models.DateField(auto_now=True, verbose_name='Atualizão')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni.cog', 'Engrenagem'), ('lni.stats', 'Grafico'), ('lni.users', 'Usuario'), ('lni.layers', 'Design'), ('lni.mobile', 'Mobile'), ('lni.rocket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
